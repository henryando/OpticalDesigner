...
// looks native alongside the local-project prompts in App.jsx. Pass
// `inline` to render just the form (no backdrop/title) for embedding
// directly in a page, e.g. at the top of the Cloud Storage tab.
